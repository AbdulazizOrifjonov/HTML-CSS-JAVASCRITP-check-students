...
const CHAT_IDS = [
  "-1003377614514",   // eski kanal
  "-1003663002176"    // har doim qo‘shiladigan kanal
];
...
const SCHEDULE = {
  ...
  Friday: [
    "Dinshunoslik - Lecture (Lecture 234)",
...
const INITIAL_STUDENTS = [
  ...
  { id: 8, name: "Farrux G'aniboyev", status: "Nomalum", reason: "" },
  { id: 9, name: "Foziljon Mo'minov", status: "Nomalum", reason: "" },
  { id: 10, name: "Jamoliddin Murodullayev", status: "Nomalum", reason: "" },
  { id: 11, name: "Madinabonu Axmadjonova", status: "Nomalum", reason: "" },
  { id: 12, name: "Madinaxon Maxmudova", status: "Nomalum", reason: "" },
  { id: 13, name: "Mohinur Nosirjonova", status: "Nomalum", reason: "" },
  { id: 14, name: "Muhammadali Xoshimov", status: "Nomalum", reason: "" },
  { id: 15, name: "Muhammadbobur Mansurov", status: "Nomalum", reason: "" },
  { id: 16, name: "Muhammadmuso Qodirov", status: "Nomalum", reason: "" },
  { id: 17, name: "Og'abek Hasanov", status: "Nomalum", reason: "" },
  { id: 18, name: "Rano Yo'ldasheva", status: "Nomalum", reason: "" },
  { id: 19, name: "Sherxon Sunnatov", status: "Nomalum", reason: "" },
  { id: 20, name: "Shohjahon Soatov", status: "Nomalum", reason: "" },
  { id: 21, name: "Shamsiddin Xusanov", status: "Nomalum", reason: "" },
  { id: 22, name: "Temirova Lola", status: "Nomalum", reason: "" },
  { id: 23, name: "Umidjon Murotov", status: "Nomalum", reason: "" },
  { id: 24, name: "Urazbayeva Dinara", status: "Nomalum", reason: "" },
  { id: 25, name: "Xakimova Munisa", status: "Nomalum", reason: "" },
  { id: 26, name: "Xusan Sunnatov", status: "Nomalum", reason: "" },
  { id: 27, name: "Yahyo Ikromov", status: "Nomalum", reason: "" },
  { id: 28, name: "Zamir Tuygunov", status: "Nomalum", reason: "" },
];
