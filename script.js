...
const INITIAL_STUDENTS = [
  ...
  { id: 8, name: "Foziljon Mo'minov", status: "Nomalum", reason: "" },
  { id: 9, name: "Farrux G'aniboyev", status: "Nomalum", reason: "" },
  { id: 10, name: "Jamoliddin Murodullayev", status: "Nomalum", reason: "" },
  { id: 11, name: "Muhammadbobur Mansurov", status: "Nomalum", reason: "" },
  { id: 12, name: "Muhammadali Xoshimov", status: "Nomalum", reason: "" },
  { id: 13, name: "Muhammadmuso Qodirov", status: "Nomalum", reason: "" },
  { id: 14, name: "Madinaxon Maxmudova", status: "Nomalum", reason: "" },
  { id: 15, name: "Madinabonu Axmadjonova", status: "Nomalum", reason: "" },
  { id: 16, name: "Mohinur Nosirjonova", status: "Nomalum", reason: "" },
  { id: 17, name: "Og'abek Hasanov", status: "Nomalum", reason: "" },
  { id: 18, name: "Rano Yo'ldasheva", status: "Nomalum", reason: "" },
  { id: 19, name: "Umidjon Murotov", status: "Nomalum", reason: "" },
  { id: 20, name: "Xusan Sunnatov", status: "Nomalum", reason: "" },
  { id: 21, name: "Yahyo Ikromov", status: "Nomalum", reason: "" },
  { id: 22, name: "Zamir Tuygunov", status: "Nomalum", reason: "" },
  { id: 23, name: "Shamsiddin Xusanov", status: "Nomalum", reason: "" },
  { id: 24, name: "Shohjahon Soatov", status: "Nomalum", reason: "" },
  { id: 25, name: "Sherxon Sunnatov", status: "Nomalum", reason: "" },
  { id: 26, name: "Urazbayeva Dinara", status: "Nomalum", reason: "" },
];
